...
export default async function SigninPage() {
  return (
    <div className="flex min-h-[calc(100dvh-80px)] items-start justify-center">
      <div className="mt-56 flex flex-col items-center gap-4">
        ...
        <p className="mt-5 w-[335px] text-center">
...
const Card = () => {
  return (
    <div className="flex w-80 flex-col gap-4 rounded-xl bg-white p-6 shadow-2xl">
